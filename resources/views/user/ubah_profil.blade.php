        ...
        <div class="row justify-content-center mt-2">
            <div class="col-md-3 border-end">
                <ul class="list-group mb-5 shadow">
                    <li class="list-group-item active"><a class="nav-link" href="{{ url('ubah_profil') }}">Ubah
                            Profil</a></li>
                    <li class="list-group-item"><a class="nav-link" href="{{ url('ubah_password') }}">Ubah Kata Sandi
                        </a></li>
                </ul>
            </div>
            <div class="col-md-9">
