                ...
                <form method="POST" action="{{ url('/admin/create_user') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror"
                               value="{{ isset($admin)? $admin->name : old('name') }}" name="name" type="text"/>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('email') is-invalid @enderror"
                               value="{{ isset($admin)? $admin->email : old('email') }}" name="email" type="text"/>
                        @error('email')
                        <span class="error invalid-feedback">{{ $message }} </span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('password') is-invalid @enderror"
                               value="{{ isset($admin)? $admin->password : old('password') }}" name="password" type="password"/>
                        @error('password')
                        <span class="error invalid-feedback">{{ $message }} </span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('password_confirmation') is-invalid @enderror"
                               value="{{ isset($admin)? $admin->password : old('password_confirmation') }}" name="password_confirmation" type="password"/>
                        @error('password')
                        <span class="error invalid-feedback">{{ $message }} </span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('tanggal_lahir') is-invalid @enderror"
                               value="{{ isset($admin)? $admin->tanggal_lahir : old('tanggal_lahir') }}"
